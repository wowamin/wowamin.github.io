...
<header class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light" >
                <div class="container-fluid">
                    <a class="navbar-brand" href="index.html" style=" font-size: 2rem;"><img src="images/logo.svg" width="30%" style="margin-right: 10px;" alt="WOODMIN設計" />WOODMIN設計</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" target="_blank">關於我</a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> 平面設計 </a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="https://riverwood2023.wixsite.com/minlin125/" target="_blank">商業設計</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
